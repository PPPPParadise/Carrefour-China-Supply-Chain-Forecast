...
-- drop table if exists {database}.forecast_sales_subfamily_store_brand_date; 
create table {database}.forecast_sales_subfamily_store_brand_date as 
select 
    sub_family_code, 
    store_code, 
    holding_code, 
...
group by sub_family_code, store_code, holding_code, date_key
; 