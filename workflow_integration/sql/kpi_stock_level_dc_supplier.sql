...
select
    dc_site, in_dm, upper(rotation) as rotation, holding_code, date_key, sum(stock_available_sku) as stock_level
from
    item_dc_stock
group by
    dc_site, in_dm, upper(rotation), holding_code, date_key
