...
run_consistency = BashOperator(
    ...
    wait_for_downstream=True,
    bash_command="MONITOR_RUN_DATE='{{ ds_nodash }}' jupyter nbconvert --execute " + project_folder + '/consistency_check.ipynb --to=html --output=' + record_folder + '/monitoring/report_consistency_{{ ds_nodash }}.html --ExecutePreprocessor.timeout=3600 --no-input',
    dag=forecast_monitoring
)
